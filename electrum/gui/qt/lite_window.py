...
try:
    ...
    print "You need to have PyQT installed to run Electrum-BIT in graphical mode."
...
class MiniWindow(QDialog):
    ...
    def __init__(self, actuator, expand_callback, config):
        ...
        self.address_input.setPlaceholderText(_("Enter a Bitnet address or contact"))
        ...
        self.setWindowTitle("Electrum-BIT")
    ...
    def set_balances(self, btc_balance):
        """Set the bitnet balance and update the amount label accordingly."""
        ...
        self.setWindowTitle("Electrum-BIT %s - %s %s" % (electrum_version, amount, unit))

    def amount_input_changed(self, amount_text):
        """Update the number of bitnets displayed."""
    ...
    def check_button_status(self):
        """Check that the bitnet address is valid and that something
...
class BalanceLabel(QLabel):
    ...
    def set_balance_text(self, amount, unit, quote_text):
        """Set the amount of bitnets in the gui."""
        if self.state == self.SHOW_CONNECTING:
...
class ReceivePopup(QDialog):
    ...
    def setup(self, address):
        label = QLabel(_("Copied your Bitnet address to the clipboard!"))
        ...
        self.setWindowTitle("Electrum-BIT - " + _("Receive Bitnet payment"))
...
class MiniActuator:
    ...
    def send(self, address, amount, parent_window):
        """Send bitnets to the target address."""
